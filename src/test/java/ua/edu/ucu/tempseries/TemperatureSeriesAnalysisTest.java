...
public class TemperatureSeriesAnalysisTest {
    ...
    public void testTempSummaryStatistics() {
        double[] temperatureSeries = {3.0, -5.0, 1.0, 5.0};
        double av = 1.0;
        double dev = 3.7416573867739413;
        double min = -5.0;
        double max = 5.0;
        TemperatureSeriesAnalysis seriesAnalysis = new TemperatureSeriesAnalysis(temperatureSeries);
        TempSummaryStatistics expResult = new TempSummaryStatistics(av, dev, min, max);
    ...
    public void testAddTemps() {
        double[] temperatureSeries = {3.0, -5.0, 1.0, 5.0};
        double[] newValues = {2.0, 6.0, 7.0};
        TemperatureSeriesAnalysis seriesAnalysis = new TemperatureSeriesAnalysis(temperatureSeries);

        int expResult = 7;
        int actualResult = seriesAnalysis.addTemps(newValues);
